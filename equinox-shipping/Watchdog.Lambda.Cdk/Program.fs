...
let main _ =
    ...
    let codePath, topicArn, storeTableName, indexTableName =
        match app.Node.TryGetContext codePathArg, app.Node.TryGetContext topicNameArg, app.Node.TryGetContext storeTableNameArg, app.Node.TryGetContext indexTableNameArg with
