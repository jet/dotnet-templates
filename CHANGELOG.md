...
- Added `tests/Equinox.Templates.Tests` to allow repo to validate integrity of templates within [#67](https://github.com/jet/dotnet-templates/pull/67) [#2](https://github.com/jet/dotnet-templates/issues/2)
