...
type ParallelConsumer =
    ...
    static member Start<'M>
        ...
        let mapBatch onCompletion (x : Submission.Batch<_>) : ParallelScheduling.Batch<'M> =
...
type StreamSpanConsumer =
    ...
    static member Start<'M>
        ...
        let dispatcher = StreamScheduling.Dispatcher<_> maxDop
        let stats = StreamScheduling.Stats(log, statsInterval, stateInterval)
